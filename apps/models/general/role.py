...
class Role(db.Model):
    ...
    def insert_roles(cls):
        ...
        """
        roles = {
            'Rumbu_Ceo': {'description': "Oversee Rumbu operations and strategy", 'position': 'CEO'},
            'Rumbu_HR_Manager': {'description': 'Manage human resources tasks and employee relations for Ressync', 'position': 'HR Manager'},
            'Rumbu_Accountant': {'description': 'Handle financial tasks, bookkeeping, and transactions for Ressync', 'position': 'Accountant'},
            'Rumbu_Sales_Director': {'description': 'Oversee sales operations and strategies for Ressync', 'position': 'Ressync Sales Director'},
